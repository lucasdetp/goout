...
class SoireeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('soirees.show', $soiree->id)->with('success', 'Ta soirée à bien été créée !');
    }
    ...
    public function destroy(Soiree $soiree)
    {
        ...
        return redirect()->route('soirees.index')->with('success', 'Votre soirée à bien été supprimer !');
    }
