<x-app-layout>
        ...
        <div class="search-form">
            <form action="{{ route('soirees.search') }}" method="GET">
                <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-primary button"><img src="images/search.png" alt="">Rechercher</button>
                </div>
            </form>
        </div>
        <div class="search-p">
    ...
    <div class="container-2">
        ...
        <div class="btn-premium">
            <img src="images/btn_gauche.png" alt="">
            <button>Essayez maintenant !</button>
            <img src="images/btn_droit.png" alt="">
        </div>
    </div>
    <!-- avis -->
    <div class="avis-container">
        <h1>Vous en parlez mieux que nous</h1>
        <img src="images/coeur2.png" alt="">
        <img id="coeur1" src="images/coeur1.png" alt="">
    </div>
